...
- English (Fluent)
- Portuguese (Native)
- German (A2, B1 exam scheduled for 28/05/2025)
...
dashboards and reports to answer stakeholder's analytical requests.
...
Department of Psychological Methods - Humboldt-University 
...
<!-- - Developed Bash scripts to make use of high performance computing clusters and threading in order to improve computations speed and scale.  -->
- Use of high performance computing clusters and threading in order to provide scalable modeling solutions.
- Applied hierarchical Bayesian regression and mixture modeling techniques, using the Stan probabilistic programming language, to account for different aspects 
of how the data was structured and generated.
